...
let weatherImages = [
    {
        url: 'weather img/clear-sky.png',
        ids: [800]
    },
    {
        url: 'weather img/broken-clouds.png',
        ids: [803, 804]
    },
    {
        url: 'weather img/few-clouds.png',
        ids: [801]
    },
    {
        url: 'weather img/mist.png',
        ids: [701, 711, 721, 731, 741, 751, 761, 762, 771, 781]
    },
    {
        url: 'weather img/rain.png',
        ids: [500, 501, 502, 503, 504]
    },
    {
        url: 'weather img/scattered-clouds.png',
        ids: [802]
    },
    {
        url: 'weather img/shower-rain.png',
        ids: [520, 521, 522, 531, 300, 301, 302, 310, 311, 312, 313, 314, 321]
    },
    {
        url: 'weather img/snow.png',
        ids: [511, 600, 601, 602, 611, 612, 613, 615, 616, 620, 621, 622]
    },
    {
        url: 'weather img/thnderstorm.png',
...
let init = () => {
    weatherForCity('Johannesburg').then(() => document.body.style.filter = 'blur(0)');
}
init();
